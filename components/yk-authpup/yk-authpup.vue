			...
			return {
				...
				authList: {
					'WRITE_EXTERNAL_STORAGE': {
						...
						content: "便于您使用该功能上传您的照片/图片/及用于更换头像、上传报价单LOGO、购买商品上传转账凭证等场景中读取和写入相册和文件内容。"
					},
					'ACCESS_FINE_LOCATION': {
						title: "易揽通对地理位置权限申请说明",
						content: "便于应用程序可以提供基于位置的服务、定位导航、附近搜索等功能。"
					},
					'CAMERA':{
						title: "易揽通对相机/摄像头权限申请说明",
						content: "便于您使用该功能拍照上传您的照片及用于更换头像、更改个人资料、购买商品上传转账凭证、等场景中使用"
					},
					'RECORD_AUDIO':{
						title: "易揽通对麦克风权限申请说明",
